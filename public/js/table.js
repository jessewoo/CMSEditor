...
var buildDummyTable = function() {
  var newRow = "<tr>";
  newRow += "<td>191</td>";
  newRow += "<td><img class='img-thumbnail' src='http://www.rcsb.org/pdb/education_discussion/molecule_of_the_month/images/191-GlutamateGatedChlorideReceptors_3rif.jpg'/></td>";
  newRow += "<td>Glutamate-gated Chloride Receptors</td>";
  newRow += "<td><button class='btn btn-primary'>Action Dropdown</button></td>"
  newRow += "</tr>";
...
// CURRENTLY WAITING FOR DATABASE PULL
